...
- [**Singleton Shortcuts**](./SingletonShortcuts) - Little helper scripts to quickly open the floating Property Editor window for singleton Scriptable Objects or MonoBehaviour components directly from the menu item.
